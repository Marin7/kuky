...
export interface UniversityStudent extends RegisteredUser {
  universityLevel: UniversityLevel;
}

export interface UniversityScheduleSession {
  id: string;
...
export interface UniversityScheduleException {
  id: string;
  level: UniversityLevel;
...
export interface UniversityExamAdmin {
  id: string;
  title: string;
  examAt: string;
...
export interface UniversityNewsAdmin {
  id: string;
  title: string;
  body: string;
  published: boolean;
...
export const getUniversityStudents = () =>
  apiCall<UniversityStudent[]>(`${universityPath}/students`);
export const grantUniversityStudent = (id: string, level: UniversityLevel) =>
  apiCall<UniversityStudent>(`/users/${id}/university-student`, {
    method: "POST",
    body: JSON.stringify({ level }),
  });
export const revokeUniversityStudent = (id: string) =>
  apiCall<void>(`/users/${id}/university-student`, { method: "DELETE" });
export const updateUniversityLevel = (id: string, level: UniversityLevel) =>
  apiCall<UniversityStudent>(`/users/${id}/university-level`, {
    method: "PUT",
    body: JSON.stringify({ level }),
  });

export const getUniversitySessions = () =>
  apiCall<UniversityScheduleSession[]>(`${universityPath}/schedule/sessions`);
export const saveUniversitySession = (
  session: Omit<UniversityScheduleSession, "id">,
  id?: string,
) =>
  apiCall<UniversityScheduleSession>(
    `${universityPath}/schedule/sessions${id ? `/${id}` : ""}`,
    { method: id ? "PUT" : "POST", body: JSON.stringify(session) },
  );
export const deleteUniversitySession = (id: string) =>
  apiCall<void>(`${universityPath}/schedule/sessions/${id}`, { method: "DELETE" });
export const getUniversityExceptions = () =>
  apiCall<UniversityScheduleException[]>(
    `${universityPath}/schedule/exceptions`,
  );
export const createUniversityException = (
  exception: Omit<UniversityScheduleException, "id">,
) =>
  apiCall<UniversityScheduleException>(`${universityPath}/schedule/exceptions`, {
    method: "POST",
    body: JSON.stringify(exception),
  });
export const deleteUniversityException = (id: string) =>
  apiCall<void>(`${universityPath}/schedule/exceptions/${id}`, {
    method: "DELETE",
  });

export const getUniversityExamsAdmin = () =>
  apiCall<UniversityExamAdmin[]>(`${universityPath}/exams`);
export const saveUniversityExam = (
  exam: Omit<UniversityExamAdmin, "id">,
  id?: string,
) =>
  apiCall<UniversityExamAdmin>(`${universityPath}/exams${id ? `/${id}` : ""}`, {
    method: id ? "PUT" : "POST",
    body: JSON.stringify(exam),
  });
export const deleteUniversityExam = (id: string) =>
  apiCall<void>(`${universityPath}/exams/${id}`, { method: "DELETE" });

export const getUniversityNewsAdmin = () =>
  apiCall<UniversityNewsAdmin[]>(`${universityPath}/news`);
export const saveUniversityNews = (
  news: Omit<UniversityNewsAdmin, "id">,
  id?: string,
) =>
  apiCall<UniversityNewsAdmin>(`${universityPath}/news${id ? `/${id}` : ""}`, {
    method: id ? "PUT" : "POST",
    body: JSON.stringify(news),
  });
export const deleteUniversityNews = (id: string) =>
  apiCall<void>(`${universityPath}/news/${id}`, { method: "DELETE" });

export const getUniversityHomeworkAvailability = (level: UniversityLevel) =>
  apiCall<string[]>(`${universityPath}/levels/${level}/homeworks`);
export const setUniversityHomeworkAvailability = (
  level: UniversityLevel,
  assignmentIds: string[],
) =>
  apiCall<void>(`${universityPath}/levels/${level}/homeworks`, {
    method: "PUT",
    body: JSON.stringify({ assignmentIds }),
  });
export const getUniversityPresentationAvailability = (level: UniversityLevel) =>
  apiCall<string[]>(`${universityPath}/levels/${level}/presentations`);
export const setUniversityPresentationAvailability = (
  level: UniversityLevel,
  presentationIds: string[],
) =>
  apiCall<void>(`${universityPath}/levels/${level}/presentations`, {
    method: "PUT",
    body: JSON.stringify({ presentationIds }),
  });
