export const esDict = {
  nav: {
    ...
    universityHome: "Universidad",
    universitySchedule: "Horario",
    universityExams: "Exámenes",
    universityNews: "Noticias",
    universityLearning: "Mi aprendizaje",
    panel: "Panel",
    account: "Mi cuenta",
  ...
  university: {
    title: "Universidad",
    home: "Espacio del alumnado universitario",
    schedule: "Horario",
    exams: "Exámenes",
    news: "Noticias",
    learning: "Mi aprendizaje",
    accessRequired: "Acceso universitario requerido",
    askTeacher: "Contacta con Paula si crees que deberías tener acceso.",
