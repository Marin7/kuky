export const esDict = {
  ...
  quiz: {
    title: "Quizzes",
    empty: "Aún no tienes quizzes asignados.",
    loading: "Cargando quizzes…",
    loadError: "No se pudieron cargar los quizzes.",
    loginRequired: "Inicia sesión para ver tus quizzes.",
    back: "← Volver a Quizzes",
    submit: "Entregar quiz",
    submitting: "Entregando…",
    ...
    admin: {
      ...
      noStudentQuizzes: "Este alumno no tiene quizzes entregados.",
    },
  },
  seo: {
