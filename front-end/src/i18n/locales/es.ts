export const esDict = {
  ...
  admin: {
    ...
    homework: {
      ...
      assign: "Asignar",
      assignError: "No se pudo guardar la asignación.",
      dueOnInPast: "La fecha límite no puede ser anterior a hoy.",
      noStudents: "No hay alumnos disponibles.",
      assignedTo: "Asignada a",
      details: "Detalles",
      ...
      editor: {
        ...
        assignDueDateLabel: "Fecha límite para los nuevos alumnos (opcional)",
        assignDueDateHint:
          "Solo se aplica a los alumnos que añades ahora. Los que ya están asignados conservan su fecha.",
        cancel: "Cancelar",
        save: "Guardar",
        saving: "Guardando…",
      },
