export const roDict = {
  nav: {
    ...
    universityHome: "Universitate",
    universitySchedule: "Orar",
    universityExams: "Examene",
    universityNews: "Noutăți",
    universityLearning: "Învățarea mea",
    panel: "Panou",
    account: "Contul meu",
  ...
  university: {
    title: "Universitate",
    home: "Spațiul studenților universitari",
    schedule: "Orar",
    exams: "Examene",
    news: "Noutăți",
    learning: "Învățarea mea",
    accessRequired: "Este necesar acces universitar",
    askTeacher: "Contactează-o pe Paula dacă ar trebui să ai acces.",
    loadError: "Informațiile nu au putut fi încărcate.",
  },
  seo: {
