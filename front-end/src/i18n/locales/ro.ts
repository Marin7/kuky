export const roDict = {
  ...
  learning: {
    ...
    manualMulti: {
      ...
      submit: "Predă tema",
      submitting: "Se predă…",
      allRequired: "Răspunde la toate întrebările înainte de a preda.",
      noQuestions: "Această temă nu are încă întrebări.",
    ...
    units: {
      ...
      homework: "Teme",
      itemPresentation: "Prezentare",
      itemHomework: "Temă",
      presentationsCountSingular: "{{count}} prezentare",
      presentationsCountPlural: "{{count}} prezentări",
      homeworkCountSingular: "{{count}} temă",
      homeworkCountPlural: "{{count}} teme",
      pendingBadge: "În așteptare",
      openUnit: "Deschide unitatea",
      back: "Înapoi la Învățarea mea",
      notFound: "Unitatea nu a fost găsită.",
      unitEmpty: "Această unitate nu are încă conținut.",
      inlineLoading: "Se încarcă…",
      inlineLoadError: "Nu s-a putut încărca conținutul.",
      viewingFile: "Se afișează",
    },
    activities: {
      listTitle: "Activități",
      loading: "Se încarcă activitatea…",
      loadError: "Activitatea nu a putut fi încărcată.",
      back: "← Înapoi la învățare",
      instructions: "Instrucțiuni",
      instructionsOnPage:
        "Instrucțiunile sunt pe pagina {{page}} a prezentării.",
      insertAfterPage: "Apare după pagina {{page}} a prezentării.",
      submit: "Predă activitatea",
      overlayTitle: "Activitate",
      viewActivity: "Vezi activitatea «{{title}}»",
      hideActivity: "Ascunde activitatea «{{title}}»",
      promptMessage: "Activitate pe pagina {{page}}: «{{title}}»",
      promptOpen: "Deschide",
      promptDismiss: "Nu acum",
    },
    resultDialog: {
      loading: "Se încarcă rezultatul…",
      loadError: "Nu s-a putut încărca rezultatul.",
    },
  },
  admin: {
    panel: {
    ...
    tabs: {
      ...
      quizzes: "Probe de evaluare",
      testimonials: "Testimoniale",
    },
    activities: {
      title: "Activități",
      loading: "Se încarcă…",
      empty: "Nu există activități încă.",
      newActivity: "Activitate nouă",
      loadError: "Activitățile nu au putut fi încărcate.",
      deleteConfirm: "Ștergi această activitate?",
      presentation: "Prezentare",
      instructions: "Instrucțiuni",
      instructionsText: "Text cu instrucțiuni",
      youtubeUrl: "Video YouTube",
      ...
      triggerFilePlaceholder: "Alege un PDF",
      triggerPage: "După pagina",
      triggerHint:
        "Activitatea se inserează între această pagină și următoarea (nu înlocuiește pagina).",
      triggerSummary: "După pagina {{page}}",
      noTrigger: "Fără inserare",
      save: "Salvează",
      cancel: "Anulează",
      reorderError: "Reordonarea a eșuat.",
      reviewQueueTitle: "Activități de revizuit",
      reviewQueueEmpty: "Nu există predări de activități în așteptare.",
      reviewAction: "Revizuiește",
      reviewTitle: "Revizuiește activitatea",
      reviewLoadError: "Predarea nu a putut fi încărcată.",
      reviewGenericError: "Revizuirea nu a putut fi salvată.",
      allPresentations: "Toate prezentările",
      edit: "Editează",
      delete: "Șterge",
      moveUp: "Mută în sus",
      ...
      editor: {
        ...
        editTitle: "Editează activitatea",
        backToPanel: "← Înapoi la panou",
        loading: "Se încarcă activitatea…",
        loadError: "Activitatea nu a putut fi încărcată.",
        saveError: "Activitatea nu a putut fi salvată.",
        requiredError: "Titlul și prezentarea sunt obligatorii.",
        instructionsRequired: "Scrie instrucțiunile activității.",
        mediaRequired: "Adaugă un video YouTube sau o fotografie (sau ambele).",
        youtubeInvalid: "Introdu un URL YouTube valid.",
        imageUploadError: "Imaginea nu a putut fi încărcată.",
        uploadingImage: "Se încarcă imaginea…",
        triggerPageError: "Introdu un număr de pagină valid (≥ 1).",
        triggerFileError: "Alege PDF-ul prezentării.",
        noPdfError: "Această prezentare nu are niciun PDF.",
        titleLabel: "Titlu",
        presentationPlaceholder: "Alege o prezentare",
        saving: "Se salvează…",
      },
    },
    testimonials: {
    ...
    units: {
      ...
      contents: {
        sequence: "Conținutul acestei unități",
        empty: "Nicio prezentare sau temă.",
        ...
        reorderError: "Nu s-a putut salva ordinea.",
        moveUp: "Mută în sus",
        moveDown: "Mută în jos",
        typePresentation: "Prezentare",
        typeHomework: "Temă",
        ...
        download: "Descarcă",
        downloading: "Se descarcă…",
        downloadError: "Nu s-a putut descărca fișierul.",
        deleteFile: "Elimină",
    ...
    homework: {
      ...
      assign: "Atribuie",
      assignError: "Nu s-a putut salva atribuirea.",
      dueOnInPast: "Termenul limită nu poate fi în trecut.",
      noStudents: "Niciun student disponibil.",
      ...
      editor: {
        ...
        labelLabel: "Etichete (opțional)",
        labelPlaceholder: "Adaugă etichetă",
        labelSearch: "Scrie sau alege o etichetă…",
        labelEmpty: "Scrie o etichetă nouă.",
        labelClear: "Elimină eticheta",
        labelRemove: "Elimină {{label}}",
        labelUseNew: "Folosește „{{label}}”",
        labelSavesImmediately:
          "Se salvează când le adaugi sau le scoți, fără a apăsa Salvează.",
        labelSavesOnCreate: "Se salvează la crearea temei.",
        ...
        assignDueDateLabel: "Termen pentru elevii nou adăugați (opțional)",
        assignDueDateHint:
          "Se aplică doar elevilor pe care îi adaugi acum. Cei deja asignați își păstrează data.",
        cancel: "Anulează",
        save: "Salvează",
        saving: "Se salvează…",
      },
      ...
      manualQuestions: {
        title: "Întrebări cu răspuns liber",
        hint: "Elevul va răspunde la fiecare întrebare cu text liber. Adaugă cel puțin una.",
        empty: "Nu ai adăugat încă întrebări. Este nevoie de cel puțin una.",
        countSingular: "{{count}} întrebare",
        countPlural: "{{count}} întrebări",
        questionLabel: "Întrebarea {{index}}",
        promptPlaceholder: "Scrie enunțul întrebării…",
        addQuestion: "Adaugă întrebare",
        remove: "Șterge",
      },
    },
    homeworkReview: {
      ...
      studentAnswers: "Răspunsurile elevului",
      questionPrompt: "Întrebarea {{index}}",
      answerLabel: "Răspuns",
    ...
    studentProfile: {
      ...
      expandHomework: "Arată toate temele",
      collapseHomework: "Ascunde temele",
  ...
  quiz: {
    title: "Probe de evaluare",
    empty: "Nu ai încă probe de evaluare asignate.",
    loading: "Se încarcă probele de evaluare…",
    loadError: "Probele de evaluare nu au putut fi încărcate.",
    loginRequired: "Conectează-te pentru a vedea probele de evaluare.",
    back: "← Înapoi la Învățarea mea",
    open: "Deschide proba",
    submit: "Trimite proba",
    submitting: "Se trimite…",
    awaiting: "Paula revizuiește răspunsurile tale scrise.",
    score: "{{percent}}% · {{correct}} / {{total}} corecte",
    skillsTitle: "Rezultat pe destreză",
    skillAwaiting: "În așteptarea corectării",
    skills: {
      READING: "Citire",
      WRITING: "Scriere",
      GRAMMAR: "Gramatică",
      LISTENING: "Înțelegere orală",
    },
    status: {
    ...
    admin: {
      tab: "Probe de evaluare",
      title: "Probe de evaluare",
      newQuiz: "Probă de evaluare nouă",
      empty: "Nu există probe de evaluare încă.",
      loadError: "Probele de evaluare nu au putut fi încărcate.",
      questions: "{{count}} întrebări",
      assignees: "{{count}} elevi",
      attempts: "{{count}} livrări",
      assign: "Asignează",
      deleteConfirm: "Ștergi această probă de evaluare?",
      titleLabel: "Titlu",
      description: "Descriere (opțional)",
      skill: "Destreză",
      addSkill: "Adaugă destreză",
      removeSkill: "Elimină destreza",
      listeningMedia: "Audio sau video pentru această întrebare",
      saveError: "Proba de evaluare nu a putut fi salvată.",
      assignError:
        "Nu s-a putut asigna. Proba are nevoie de cel puțin o întrebare.",
      attemptsTitle: "Livrări",
      noAttempts: "Nimeni nu a trimis această probă încă.",
      queueTitle: "Probe de evaluare de revizuit",
      queueEmpty:
        "Nu există livrări de probe de evaluare în așteptarea corectării.",
      review: "Revizuiește",
      view: "Vezi",
      alreadyGraded: "Această probă de evaluare a fost deja notată.",
      finalize: "Finalizează nota",
      saveProgress: "Salvează progresul",
      teacherPercent: "Procent (0–100)",
      note: "Notă pentru elev (max. 500)",
      studentQuizzes: "Probe de evaluare",
      noStudentQuizzes: "Acest elev nu are probe de evaluare trimise.",
    },
  },
  seo: {
