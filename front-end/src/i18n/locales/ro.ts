export const roDict = {
  ...
  quiz: {
    title: "Quizzes",
    empty: "Nu ai încă quizzes asignate.",
    loading: "Se încarcă quizzes…",
    loadError: "Quizzes-urile nu au putut fi încărcate.",
    loginRequired: "Conectează-te pentru a vedea quizzes-urile.",
    back: "← Înapoi la Quizzes",
    submit: "Trimite quiz-ul",
    submitting: "Se trimite…",
    ...
    admin: {
      ...
      title: "Quizzes",
      newQuiz: "Quiz nou",
      empty: "Nu există quizzes încă.",
      loadError: "Quizzes-urile nu au putut fi încărcate.",
      questions: "{{count}} întrebări",
      assignees: "{{count}} elevi",
      attempts: "{{count}} livrări",
      assign: "Asignează",
      deleteConfirm: "Ștergi acest quiz?",
      titleLabel: "Titlu",
      description: "Descriere (opțional)",
      skill: "Destreză",
      listeningMedia: "Audio sau video pentru această întrebare",
      saveError: "Quiz-ul nu a putut fi salvat.",
      assignError: "Nu s-a putut asigna. Quiz-ul are nevoie de cel puțin o întrebare.",
      attemptsTitle: "Livrări",
      noAttempts: "Nimeni nu a trimis acest quiz încă.",
      review: "Revizuiește",
      ...
      noStudentQuizzes: "Acest elev nu are quizzes trimise.",
    },
  },
  seo: {
