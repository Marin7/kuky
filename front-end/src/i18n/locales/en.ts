export const enDict = {
  ...
  admin: {
    ...
    homework: {
      ...
      assign: "Assign",
      assignError: "Could not save the assignment.",
      dueOnInPast: "The due date cannot be in the past.",
      noStudents: "No students available.",
      assignedTo: "Assigned to",
      details: "Details",
      ...
      editor: {
        ...
        labelLabel: "Labels (optional)",
        labelPlaceholder: "Add label",
        labelSearch: "Type or pick a label…",
        labelEmpty: "Type a new label.",
        labelClear: "Remove label",
        labelRemove: "Remove {{label}}",
        labelUseNew: "Use “{{label}}”",
        labelSavesImmediately:
          "Saved when you add or remove them — no need to click Save.",
        labelSavesOnCreate: "Saved when you create the homework.",
        ...
        assignDueDateLabel: "Due date for newly added students (optional)",
        assignDueDateHint:
          "Applies only to students you add now. Current assignees keep their existing date.",
        cancel: "Cancel",
        save: "Save",
        saving: "Saving…",
      },
