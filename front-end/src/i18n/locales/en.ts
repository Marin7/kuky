export const enDict = {
  ...
  quiz: {
    title: "Quizzes",
    empty: "You don't have any assigned quizzes yet.",
    loading: "Loading quizzes…",
    loadError: "Could not load quizzes.",
    loginRequired: "Log in to see your quizzes.",
    ...
    admin: {
      ...
      saveError: "Could not save the quiz.",
      assignError: "Could not assign. The quiz needs at least one question.",
      attemptsTitle: "Submissions",
      noAttempts: "Nobody has submitted this quiz yet.",
      review: "Review",
      ...
      noStudentQuizzes: "This student has no submitted quizzes.",
    },
  },
  seo: {
