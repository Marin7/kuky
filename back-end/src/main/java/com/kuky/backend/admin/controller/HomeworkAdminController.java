...
public class HomeworkAdminController {
    ...
    public HomeworkAdminItem updateLabels(@PathVariable UUID id,
                                          @Valid @RequestBody UpdateHomeworkLabelsRequest request) {
        return service.updateLabels(id, request.labels());
    }
